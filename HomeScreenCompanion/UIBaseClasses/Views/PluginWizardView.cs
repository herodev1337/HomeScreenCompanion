...
{
    public abstract class PluginWizardView : PluginViewBase, IPluginWizardView
    {
        ...
        public virtual Task<IPluginUIView> OnPreviousCommand(string providerId, string commandId, string data)
        {
            return Task.FromResult<IPluginUIView>(null);
        }
