...
namespace HomeScreenCompanion
{
    public partial class HomeScreenCompanionTask
    {
        ...
        // ─── Output-level resolvers + target selectors ──────────────────────────────────
        // Used by Execute and RunSingleEntryInternalAsync to redirect matched MediaInfo items
        // to the user-selected level (Episode / Season / Series) for tag and collection output.
