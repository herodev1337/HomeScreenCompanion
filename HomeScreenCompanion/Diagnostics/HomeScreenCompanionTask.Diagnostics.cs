...
namespace HomeScreenCompanion
{
    public partial class HomeScreenCompanionTask
    {
        ...
        // Date-schedule evaluator used by every "is this group active right now?" call site
        // (HomeSections, Collections, HomeSectionSyncTask keeps its own copy). Returns true when
        // `intervals` is null/empty or when the current local time falls inside at least one
        // Weekly / EveryYear / one-off interval.
